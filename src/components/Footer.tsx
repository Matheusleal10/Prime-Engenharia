...
const Footer = () => {
  return (
    <footer className="bg-prime-concrete-dark text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <img 
              ...
              className="h-16 lg:h-20 w-auto mb-4 brightness-0 invert"
            />
            <p className="text-gray-300 text-sm leading-relaxed">
              Pioneira na produção de tijolos ecológicos em São Luís - MA. 
              Qualidade, sustentabilidade e inovação para suas construções.
            </p>
          </div>
          ...
          {/* Contato Rápido */}
          <div>
            <h3 className="text-lg font-bold mb-4">Contato Rápido</h3>
