...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-prime-green to-prime-green-light pt-32 lg:pt-44">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a href="https://wa.me/5598982350016" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-transparent border-2 border-white text-white hover:bg-white hover:text-prime-green px-6 py-3 rounded-full text-lg font-medium transition-all duration-300">
