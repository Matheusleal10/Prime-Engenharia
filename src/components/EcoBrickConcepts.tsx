...
const EcoBrickConcepts = () => {
  ...
  return <section className="py-16 lg:py-24 bg-gradient-to-br from-prime-green/5 to-prime-orange/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="animate-slide-up">
            <div className="relative rounded-2xl shadow-2xl h-96 overflow-hidden">
              <img src="/lovable-uploads/53e1bebf-da3f-4251-9235-b8d02d67f457.png" alt="Tijolo Ecológico PRIME ENGENHARIA" className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500" />
          ...
          <div className="animate-slide-up">
            ...
            <div className="space-y-6">
              {concepts.map((concept, index) => <div key={index} className="flex items-start space-x-4 p-4 bg-white/70 rounded-xl hover:bg-white transition-colors duration-300 animate-fade-in" style={{
